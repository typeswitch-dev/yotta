...
: EVEX.SX.NP.0F   CALL> REX/VEX ^62 ^F1 ^7C ^08 OPCODE ;
: EVEX.SX.66.0F   CALL> REX/VEX ^62 ^F1 ^7D ^08 OPCODE ;
: EVEX.SX.F3.0F   CALL> REX/VEX ^62 ^F1 ^7E ^08 OPCODE ;
: EVEX.SX.F2.0F   CALL> REX/VEX ^62 ^F1 ^7F ^08 OPCODE ;
: EVEX.SX.NP.0F38 CALL> REX/VEX ^62 ^F2 ^7C ^08 OPCODE ;
: EVEX.SX.66.0F38 CALL> REX/VEX ^62 ^F2 ^7D ^08 OPCODE ;
: EVEX.SX.F3.0F38 CALL> REX/VEX ^62 ^F2 ^7E ^08 OPCODE ;
: EVEX.SX.F2.0F38 CALL> REX/VEX ^62 ^F2 ^7F ^08 OPCODE ;
: EVEX.SX.NP.0F3A CALL> REX/VEX ^62 ^F3 ^7C ^08 OPCODE ;
: EVEX.SX.66.0F3A CALL> REX/VEX ^62 ^F3 ^7D ^08 OPCODE ;
: EVEX.SX.F3.0F3A CALL> REX/VEX ^62 ^F3 ^7E ^08 OPCODE ;
: EVEX.SX.F2.0F3A CALL> REX/VEX ^62 ^F3 ^7F ^08 OPCODE ;
: EVEX.DX.NP.0F   CALL> REX/VEX ^62 ^F1 ^FC ^08 OPCODE ;
: EVEX.DX.66.0F   CALL> REX/VEX ^62 ^F1 ^FD ^08 OPCODE ;
: EVEX.DX.F3.0F   CALL> REX/VEX ^62 ^F1 ^FE ^08 OPCODE ;
: EVEX.DX.F2.0F   CALL> REX/VEX ^62 ^F1 ^FF ^08 OPCODE ;
: EVEX.DX.NP.0F38 CALL> REX/VEX ^62 ^F2 ^FC ^08 OPCODE ;
: EVEX.DX.66.0F38 CALL> REX/VEX ^62 ^F2 ^FD ^08 OPCODE ;
: EVEX.DX.F3.0F38 CALL> REX/VEX ^62 ^F2 ^FE ^08 OPCODE ;
: EVEX.DX.F2.0F38 CALL> REX/VEX ^62 ^F2 ^FF ^08 OPCODE ;
: EVEX.DX.NP.0F3A CALL> REX/VEX ^62 ^F3 ^FC ^08 OPCODE ;
: EVEX.DX.66.0F3A CALL> REX/VEX ^62 ^F3 ^FD ^08 OPCODE ;
: EVEX.DX.F3.0F3A CALL> REX/VEX ^62 ^F3 ^FE ^08 OPCODE ;
: EVEX.DX.F2.0F3A CALL> REX/VEX ^62 ^F3 ^FF ^08 OPCODE ;

: EVEX.SY.NP.0F   CALL> REX/VEX ^62 ^F1 ^7C ^28 OPCODE ;
: EVEX.SY.66.0F   CALL> REX/VEX ^62 ^F1 ^7D ^28 OPCODE ;
: EVEX.SY.F3.0F   CALL> REX/VEX ^62 ^F1 ^7E ^28 OPCODE ;
: EVEX.SY.F2.0F   CALL> REX/VEX ^62 ^F1 ^7F ^28 OPCODE ;
: EVEX.SY.NP.0F38 CALL> REX/VEX ^62 ^F2 ^7C ^28 OPCODE ;
: EVEX.SY.66.0F38 CALL> REX/VEX ^62 ^F2 ^7D ^28 OPCODE ;
: EVEX.SY.F3.0F38 CALL> REX/VEX ^62 ^F2 ^7E ^28 OPCODE ;
: EVEX.SY.F2.0F38 CALL> REX/VEX ^62 ^F2 ^7F ^28 OPCODE ;
: EVEX.SY.NP.0F3A CALL> REX/VEX ^62 ^F3 ^7C ^28 OPCODE ;
: EVEX.SY.66.0F3A CALL> REX/VEX ^62 ^F3 ^7D ^28 OPCODE ;
: EVEX.SY.F3.0F3A CALL> REX/VEX ^62 ^F3 ^7E ^28 OPCODE ;
: EVEX.SY.F2.0F3A CALL> REX/VEX ^62 ^F3 ^7F ^28 OPCODE ;
: EVEX.DY.NP.0F   CALL> REX/VEX ^62 ^F1 ^FC ^28 OPCODE ;
: EVEX.DY.66.0F   CALL> REX/VEX ^62 ^F1 ^FD ^28 OPCODE ;
: EVEX.DY.F3.0F   CALL> REX/VEX ^62 ^F1 ^FE ^28 OPCODE ;
: EVEX.DY.F2.0F   CALL> REX/VEX ^62 ^F1 ^FF ^28 OPCODE ;
: EVEX.DY.NP.0F38 CALL> REX/VEX ^62 ^F2 ^FC ^28 OPCODE ;
: EVEX.DY.66.0F38 CALL> REX/VEX ^62 ^F2 ^FD ^28 OPCODE ;
: EVEX.DY.F3.0F38 CALL> REX/VEX ^62 ^F2 ^FE ^28 OPCODE ;
: EVEX.DY.F2.0F38 CALL> REX/VEX ^62 ^F2 ^FF ^28 OPCODE ;
: EVEX.DY.NP.0F3A CALL> REX/VEX ^62 ^F3 ^FC ^28 OPCODE ;
: EVEX.DY.66.0F3A CALL> REX/VEX ^62 ^F3 ^FD ^28 OPCODE ;
: EVEX.DY.F3.0F3A CALL> REX/VEX ^62 ^F3 ^FE ^28 OPCODE ;
: EVEX.DY.F2.0F3A CALL> REX/VEX ^62 ^F3 ^FF ^28 OPCODE ;

: EVEX.SZ.NP.0F   CALL> REX/VEX ^62 ^F1 ^7C ^48 OPCODE ;
: EVEX.SZ.66.0F   CALL> REX/VEX ^62 ^F1 ^7D ^48 OPCODE ;
: EVEX.SZ.F3.0F   CALL> REX/VEX ^62 ^F1 ^7E ^48 OPCODE ;
: EVEX.SZ.F2.0F   CALL> REX/VEX ^62 ^F1 ^7F ^48 OPCODE ;
: EVEX.SZ.NP.0F38 CALL> REX/VEX ^62 ^F2 ^7C ^48 OPCODE ;
: EVEX.SZ.66.0F38 CALL> REX/VEX ^62 ^F2 ^7D ^48 OPCODE ;
: EVEX.SZ.F3.0F38 CALL> REX/VEX ^62 ^F2 ^7E ^48 OPCODE ;
: EVEX.SZ.F2.0F38 CALL> REX/VEX ^62 ^F2 ^7F ^48 OPCODE ;
: EVEX.SZ.NP.0F3A CALL> REX/VEX ^62 ^F3 ^7C ^48 OPCODE ;
: EVEX.SZ.66.0F3A CALL> REX/VEX ^62 ^F3 ^7D ^48 OPCODE ;
: EVEX.SZ.F3.0F3A CALL> REX/VEX ^62 ^F3 ^7E ^48 OPCODE ;
: EVEX.SZ.F2.0F3A CALL> REX/VEX ^62 ^F3 ^7F ^48 OPCODE ;
: EVEX.DZ.NP.0F   CALL> REX/VEX ^62 ^F1 ^FC ^48 OPCODE ;
: EVEX.DZ.66.0F   CALL> REX/VEX ^62 ^F1 ^FD ^48 OPCODE ;
: EVEX.DZ.F3.0F   CALL> REX/VEX ^62 ^F1 ^FE ^48 OPCODE ;
: EVEX.DZ.F2.0F   CALL> REX/VEX ^62 ^F1 ^FF ^48 OPCODE ;
: EVEX.DZ.NP.0F38 CALL> REX/VEX ^62 ^F2 ^FC ^48 OPCODE ;
: EVEX.DZ.66.0F38 CALL> REX/VEX ^62 ^F2 ^FD ^48 OPCODE ;
: EVEX.DZ.F3.0F38 CALL> REX/VEX ^62 ^F2 ^FE ^48 OPCODE ;
: EVEX.DZ.F2.0F38 CALL> REX/VEX ^62 ^F2 ^FF ^48 OPCODE ;
: EVEX.DZ.NP.0F3A CALL> REX/VEX ^62 ^F3 ^FC ^48 OPCODE ;
: EVEX.DZ.66.0F3A CALL> REX/VEX ^62 ^F3 ^FD ^48 OPCODE ;
: EVEX.DZ.F3.0F3A CALL> REX/VEX ^62 ^F3 ^FE ^48 OPCODE ;
: EVEX.DZ.F2.0F3A CALL> REX/VEX ^62 ^F3 ^FF ^48 OPCODE ;
...
:      VMOVUPSZ< EVEX.SZ.NP.0F ^10 ; :      VMOVUPSZ> EVEX.SZ.NP.0F ^11 ;
:       MOVUPDX<   ^66 OPL ^0F ^10 ; :       MOVUPDX>   ^66 OPL ^0F ^11 ;
:      VMOVUPDX<  VEX.DX.66.0F ^10 ; :      VMOVUPDX>  VEX.DX.66.0F ^11 ;
:      VMOVUPDY<  VEX.DY.66.0F ^10 ; :      VMOVUPDY>  VEX.DY.66.0F ^11 ;
:      VMOVUPDZ< EVEX.DZ.66.0F ^10 ; :      VMOVUPDZ> EVEX.DZ.66.0F ^11 ;
...
:      VMOVSDXM<  VEX.DX.F2.0F ^10 ; :      VMOVSDXM>  VEX.DX.F2.0F ^11 ;
:      VMOVSDXX+  VEX.DX.F2.0F ^10 ; :     VMOVSDXX+>  VEX.DX.F2.0F ^11 ;
...
:     VMOVLPDXM+  VEX.DX.66.0F ^12 ; :     VMOVLPDXM>  VEX.DX.66.0F ^13 ;
:     MOVSLDUPX<   ^F3 OPL ^0F ^12 ;
:    VMOVSLDUPX<  VEX.SX.F3.0F ^12 ;
:    VMOVSLDUPY<  VEX.SY.F3.0F ^12 ;
:    VMOVSLDUPZ< EVEX.SZ.F3.0F ^12 ;
:      MOVDDUPX<   ^F2 OPL ^0F ^12 ;
:     VMOVDDUPX<  VEX.DX.F2.0F ^12 ;
:     VMOVDDUPY<  VEX.DY.F2.0F ^12 ;
:     VMOVDDUPZ< EVEX.DZ.F2.0F ^12 ;
...
:    VUNPCKLPSY+ EVEX.SZ.NP.0F ^14 ; :    VUNPCKHPSZ+ EVEX.SZ.NP.0F ^15 ;
:      UNPCKLPD<   ^66 OPL ^0F ^14 ; :      UNPCKHPD<   ^66 OPL ^0F ^15 ;
:    VUNPCKLPDX+  VEX.DX.66.0F ^14 ; :    VUNPCKHPDX+  VEX.DX.66.0F ^15 ;
:    VUNPCKLPDY+  VEX.DY.66.0F ^14 ; :    VUNPCKHPDY+  VEX.DY.66.0F ^15 ;
:    VUNPCKLPDZ+ EVEX.DZ.66.0F ^14 ; :    VUNPCKHPDZ+ EVEX.DZ.66.0F ^15 ;
...
:      VMOVAPSZ< EVEX.SZ.NP.0F ^28 ; :      VMOVAPSZ> EVEX.SZ.NP.0F ^29 ;
:       MOVAPDX<   ^66 OPL ^0F ^28 ; :       MOVAPDX>   ^66 OPL ^0F ^29 ;
:      VMOVAPDX<  VEX.DX.66.0F ^28 ; :      VMOVAPDX>  VEX.DX.66.0F ^29 ;
:      VMOVAPDY<  VEX.DY.66.0F ^28 ; :      VMOVAPDY>  VEX.DY.66.0F ^29 ;
:      VMOVAPDZ< EVEX.DZ.66.0F ^28 ; :      VMOVAPDZ> EVEX.DZ.66.0F ^29 ;
:    CVTPI2PSXM<       OPL ^0F ^2A ; :     MOVNTPSXM>       OPL ^0F ^2B ;
                                     :    VMOVNTPSXM>  VEX.SX.NP.0F ^2B ;
                                     :    VMOVNTPSYM>  VEX.SY.NP.0F ^2B ;
                                     :    VMOVNTPSZM> EVEX.SZ.NP.0F ^2B ;
:    CVTPI2PDXM<   ^66 OPL ^0F ^2A ; :     MOVNTPDXM>   ^66 OPL ^0F ^2B ;
                                     :    VMOVNTPDXM>  VEX.DX.66.0F ^2B ;
                                     :    VMOVNTPDYM>  VEX.DY.66.0F ^2B ;
                                     :    VMOVNTPDZM> EVEX.DZ.66.0F ^2B ;
:    CVTSI2SSXL<   ^F3 OPL ^0F ^2A ;
...
:     VUCOMISDX<  VEX.DX.66.0F ^2E ; :      VCOMISDX<  VEX.DX.66.0F ^2F ;
...
:    VMOVMSKPSY<  VEX.SY.NP.0F ^50 ; :      VSQRTPSY<  VEX.SY.NP.0F ^51 ;
                                     :      VSQRTPSZ< EVEX.SZ.NP.0F ^51 ;
:     MOVMSKPDX<   ^66 OPL ^0F ^50 ; :       SQRTPDX<   ^66 OPL ^0F ^51 ;
:    VMOVMSKPDX<  VEX.SX.66.0F ^50 ; :      VSQRTPDX<  VEX.DX.66.0F ^51 ;
:    VMOVMSKPDY<  VEX.SY.66.0F ^50 ; :      VSQRTPDY<  VEX.DY.66.0F ^51 ;
                                     :      VSQRTPDZ< EVEX.DZ.66.0F ^51 ;
                                     :       SQRTSSX<   ^F3 OPL ^0F ^51 ;
                                     :      VSQRTSSX+  VEX.SX.F3.0F ^51 ;
                                     :       SQRTSDX<   ^F2 OPL ^0F ^51 ;
                                     :      VSQRTSDX+  VEX.DX.F2.0F ^51 ;
...
:       VANDPSZ+ EVEX.SZ.NP.0F ^54 ; :      VANDNPSZ+ EVEX.SZ.NP.0F ^55 ;
:        ANDPDX<   ^66 OPL ^0F ^54 ; :       ANDNPDX<   ^66 OPL ^0F ^55 ;
:       VANDPDX+  VEX.DX.66.0F ^54 ; :      VANDNPDX+  VEX.DX.66.0F ^55 ;
:       VANDPDY+  VEX.DY.66.0F ^54 ; :      VANDNPDY+  VEX.DY.66.0F ^55 ;
:       VANDPDZ+ EVEX.DZ.66.0F ^54 ; :      VANDNPDZ+ EVEX.DZ.66.0F ^55 ;
...
:        VORPSZ+ EVEX.SZ.NP.0F ^56 ; :       VXORPSZ+ EVEX.SZ.NP.0F ^57 ;
:         ORPDX<   ^66 OPL ^0F ^56 ; :        XORPDX<   ^66 OPL ^0F ^57 ;
:        VORPDX+  VEX.DX.66.0F ^56 ; :       VXORPDX+  VEX.DX.66.0F ^57 ;
:        VORPDY+  VEX.DY.66.0F ^56 ; :       VXORPDY+  VEX.DY.66.0F ^57 ;
:        VORPDZ+ EVEX.DZ.66.0F ^56 ; :       VXORPDZ+ EVEX.DZ.66.0F ^57 ;
...
:       VADDPSZ+ EVEX.SZ.NP.0F ^58 ; :       VMULPSZ+ EVEX.SZ.NP.0F ^59 ;
...
:       VADDPDZ+ EVEX.DZ.66.0F ^58 ; :       VMULPDZ+ EVEX.DZ.66.0F ^59 ;
...
:    VCVTPS2PDX<  VEX.SX.NP.0F ^5A ; :    VCVTDQ2PSX<  VEX.SX.NP.0F ^5B ;
:    VCVTPS2PDY<  VEX.SY.NP.0F ^5A ; :    VCVTDQ2PSY<  VEX.SY.NP.0F ^5B ;
:    VCVTPS2PDZ< EVEX.SZ.NP.0F ^5A ; :    VCVTDQ2PSZ< EVEX.SZ.NP.0F ^5B ;
:     CVTPD2PSX<   ^66 OPL ^0F ^5A ; :     CVTPS2DQX<   ^66 OPL ^0F ^5B ;
:    VCVTPD2PSX<  VEX.DX.66.0F ^5A ; :    VCVTPS2DQX<  VEX.SX.66.0F ^5B ;
:    VCVTPD2PSY<  VEX.DY.66.0F ^5A ; :    VCVTPS2DQY<  VEX.SY.66.0F ^5B ;
:    VCVTPD2PSZ< EVEX.DZ.66.0F ^5A ; :    VCVTPS2DQZ< EVEX.SZ.66.0F ^5B ;
:     CVTSS2SDX<   ^F3 OPL ^0F ^5A ; :    CVTTPS2DQX<   ^F3 OPL ^0F ^5B ;
:    VCVTSS2SDX+  VEX.SX.F3.0F ^5A ; :   VCVTTPS2DQX<  VEX.SX.F3.0F ^5B ;
                                     :   VCVTTPS2DQY<  VEX.SY.F3.0F ^5B ;
                                     :   VCVTTPS2DQZ< EVEX.SZ.F3.0F ^5B ;
:     CVTSD2SSX<   ^F2 OPL ^0F ^5A ;
:    VCVTSD2SSX+  VEX.DX.F2.0F ^5A ;
...
:       VSUBPSZ+ EVEX.SZ.NP.0F ^5C ; :       VMINPSZ+ EVEX.SZ.NP.0F ^5D ;
:        SUBPDX<   ^66 OPL ^0F ^5C ; :        MINPDX<   ^66 OPL ^0F ^5D ;
:       VSUBPDX+  VEX.DX.66.0F ^5C ; :       VMINPDX+  VEX.DX.66.0F ^5D ;
:       VSUBPDY+  VEX.DY.66.0F ^5C ; :       VMINPDY+  VEX.DY.66.0F ^5D ;
:       VSUBPDZ+ EVEX.DZ.66.0F ^5C ; :       VMINPDZ+ EVEX.DZ.66.0F ^5D ;
...
:       VSUBSDX+  VEX.DX.F2.0F ^5C ; :       VMINSDX+  VEX.DX.F2.0F ^5D ;
...
:       VDIVPSZ+ EVEX.SZ.NP.0F ^5E ; :       VMAXPSZ+ EVEX.SZ.NP.0F ^5F ;
:        DIVPDX<   ^66 OPL ^0F ^5E ; :        MAXPDX<   ^66 OPL ^0F ^5F ;
:       VDIVPDX+  VEX.DX.66.0F ^5E ; :       VMAXPDX+  VEX.DX.66.0F ^5F ;
:       VDIVPDY+  VEX.DY.66.0F ^5E ; :       VMAXPDY+  VEX.DY.66.0F ^5F ;
:       VDIVPDZ+ EVEX.DZ.66.0F ^5E ; :       VMAXPDZ+ EVEX.DZ.66.0F ^5F ;
...
:       VDIVSDX+  VEX.DX.F2.0F ^5E ; :       VMAXSDX+  VEX.DX.F2.0F ^5F ;
...
:   VPUNPCKLBWZ+ EVEX.SZ.66.0F ^60 ; :   VPUNPCKLWDZ+ EVEX.SZ.66.0F ^61 ;
...
:   VPUNPCKLDQZ+ EVEX.SZ.66.0F ^62 ; :    VPACKSSWBZ+ EVEX.SZ.66.0F ^63 ;
...
:     VPCMPGTBZ+ EVEX.SZ.66.0F ^64 ; :     VPCMPGTWZ+ EVEX.SZ.66.0F ^65 ;
...
:     VPCMPGTDZ+ EVEX.SZ.66.0F ^66 ; :    VPACKUSWBZ+ EVEX.SZ.66.0F ^67 ;
...
:   VPUNPCKHBWZ+ EVEX.SZ.66.0F ^68 ; :   VPUNPCKHWDZ+ EVEX.SZ.66.0F ^69 ;
...
:   VPUNPCKHDQZ+ EVEX.SZ.66.0F ^6A ; :    VPACKSSDWZ+ EVEX.SZ.66.0F ^6B ;
:   PUNPCKLQDQX<   ^66 OPL ^0F ^6C ; :   PUNPCKHQDQX<   ^66 OPL ^0F ^6D ;
:  VPUNPCKLQDQX+  VEX.DX.66.0F ^6C ; :  VPUNPCKHQDQX<  VEX.DX.66.0F ^6D ;
:  VPUNPCKLQDQY+  VEX.DY.66.0F ^6C ; :  VPUNPCKHQDQY<  VEX.DY.66.0F ^6D ;
:  VPUNPCKLQDQZ+ EVEX.DZ.66.0F ^6C ; :  VPUNPCKHQDQZ< EVEX.DZ.66.0F ^6D ;

:         MOVXL<   ^66 OPL ^0F ^6E ; :       MOVDQAX<   ^66 OPL ^0F ^6F ;
:        VMOVXL<  VEX.SX.66.0F ^6E ; :    VMOVDQA32X<  VEX.SX.66.0F ^6F ;
                                     :    VMOVDQA32Y<  VEX.SY.66.0F ^6F ;
                                     :    VMOVDQA32Z< EVEX.SZ.66.0F ^6F ;
:         MOVXQ<   ^66 OPQ ^0F ^6E ;
:        VMOVXQ<  VEX.DX.66.0F ^6E ; :    VMOVDQA64X<  VEX.DX.66.0F ^6F ;
                                     :    VMOVDQA64Y<  VEX.DY.66.0F ^6F ;
                                     :    VMOVDQA64Z< EVEX.DZ.66.0F ^6F ;
                                     :       MOVDQUX<   ^F3 OPL ^0F ^6F ;
                                     :    VMOVDQU32X<  VEX.SX.F3.0F ^6F ;
                                     :    VMOVDQU32Y<  VEX.SY.F3.0F ^6F ;
                                     :    VMOVDQU32Z< EVEX.SZ.F3.0F ^6F ;
                                     :    VMOVDQU64X<  VEX.DX.F3.0F ^6F ;
                                     :    VMOVDQU64Y<  VEX.DY.F3.0F ^6F ;
                                     :    VMOVDQU64Z< EVEX.DZ.F3.0F ^6F ;
                                     :     VMOVDQU8X< EVEX.SX.F2.0F ^6F ;
                                     :     VMOVDQU8Y< EVEX.SY.F2.0F ^6F ;
                                     :     VMOVDQU8Z< EVEX.SZ.F2.0F ^6F ;
                                     :    VMOVDQU16X< EVEX.DX.F2.0F ^6F ;
                                     :    VMOVDQU16Y< EVEX.DY.F2.0F ^6F ;
                                     :    VMOVDQU16Z< EVEX.DZ.F2.0F ^6F ;

:      PSHUFDX<.   ^66 OPL ^0F ^70 ; :    PSRLWX#.   ^66 OPL ^0F ^71 /2 ;
:     VPSHUFDX<.  VEX.SX.66.0F ^70 ; :  VPSRLWX+#.  VEX.SX.66.0F ^71 /2 ;
:     VPSHUFDY<.  VEX.SY.66.0F ^70 ; :  VPSRLWY+#.  VEX.SY.66.0F ^71 /2 ;
:     VPSHUFDZ<. EVEX.SZ.66.0F ^70 ; :  VPSRLWZ+#. EVEX.SZ.66.0F ^71 /2 ;
                                     :    PSRAWX#.   ^66 OPL ^0F ^71 /4 ;
                                     :  VPSRAWX+#.  VEX.SX.66.0F ^71 /4 ;
                                     :  VPSRAWY+#.  VEX.SY.66.0F ^71 /4 ;
                                     :  VPSRAWZ+#. EVEX.SZ.66.0F ^71 /4 ;
                                     :    PSLLWX#.   ^66 OPL ^0F ^71 /6 ;
                                     :  VPSLLWX+#.  VEX.SX.66.0F ^71 /6 ;
                                     :  VPSLLWY+#.  VEX.SY.66.0F ^71 /6 ;
                                     :  VPSLLWZ+#. EVEX.SZ.66.0F ^71 /6 ;
:     PSHUFHWX<.   ^F3 OPL ^0F ^70 ;
:    VPSHUFHWX<.  VEX.SX.F3.0F ^70 ;
:    VPSHUFHWY<.  VEX.SY.F3.0F ^70 ;
:    VPSHUFHWZ<. EVEX.SZ.F3.0F ^70 ;
:     PSHUFLWX<.   ^F2 OPL ^0F ^70 ;
:    VPSHUFLWX<.  VEX.SX.F2.0F ^70 ;
:    VPSHUFLWY<.  VEX.SY.F2.0F ^70 ;
:    VPSHUFLWZ<. EVEX.SZ.F2.0F ^70 ;
:    PSRLDX#.   ^66 OPL ^0F ^72 /2 ; :    PSRLQX#.   ^66 OPL ^0F ^73 /2 ;
:  VPSRLDX+#.  VEX.SX.66.0F ^72 /2 ; :  VPSRLQX+#.  VEX.DX.66.0F ^73 /2 ;
:  VPSRLDY+#.  VEX.SY.66.0F ^72 /2 ; :  VPSRLQY+#.  VEX.DY.66.0F ^73 /2 ;
:  VPSRLDZ+#. EVEX.SZ.66.0F ^72 /2 ; :  VPSRLQZ+#. EVEX.DZ.66.0F ^73 /2 ;
                                     :   PSRLDQX#.   ^66 OPL ^0F ^73 /3 ;
                                     : VPSRLDQX+#.  VEX.DX.66.0F ^73 /3 ;
                                     : VPSRLDQY+#.  VEX.DY.66.0F ^73 /3 ;
                                     : VPSRLDQZ+#. EVEX.DZ.66.0F ^73 /3 ;
:    PSRADX#.   ^66 OPL ^0F ^72 /4 ;
:  VPSRADX+#.  VEX.SX.66.0F ^72 /4 ; :  VPSRAQX+#. EVEX.DX.66.0F ^73 /4 ;
:  VPSRADY+#.  VEX.SY.66.0F ^72 /4 ; :  VPSRAQY+#. EVEX.DY.66.0F ^73 /4 ;
:  VPSRADZ+#. EVEX.SZ.66.0F ^72 /4 ; :  VPSRAQZ+#. EVEX.DZ.66.0F ^73 /4 ;
:    PSLLDX#.   ^66 OPL ^0F ^72 /6 ; :    PSLLQX#.   ^66 OPL ^0F ^73 /6 ;
:  VPSLLDX+#.  VEX.SX.66.0F ^72 /6 ; :  VPSLLQX+#.  VEX.DX.66.0F ^73 /6 ;
:  VPSLLDY+#.  VEX.SY.66.0F ^72 /6 ; :  VPSLLQY+#.  VEX.DY.66.0F ^73 /6 ;
:  VPSLLDZ+#. EVEX.SZ.66.0F ^72 /6 ; :  VPSLLQZ+#. EVEX.DZ.66.0F ^73 /6 ;
                                     :   PSLLDQX#.   ^66 OPL ^0F ^73 /7 ;
                                     : VPSLLDQX+#.  VEX.DX.66.0F ^73 /7 ;
                                     : VPSLLDQY+#.  VEX.DY.66.0F ^73 /7 ;
                                     : VPSLLDQZ+#. EVEX.DZ.66.0F ^73 /7 ;
